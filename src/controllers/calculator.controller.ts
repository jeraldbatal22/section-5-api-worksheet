...
class CalculatorController {
  ...
  async calculate(req: I_AuthRequest, res: Response, next: NextFunction): Promise<void> {
    try {
  ...
  async getById(req: I_AuthRequest, res: Response, next: NextFunction): Promise<void> {
    try {
